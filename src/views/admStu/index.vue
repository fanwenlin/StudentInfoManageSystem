<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="tmpName" label="学生姓名" sortable>
        <template slot-scope="scope">
          {{ scope.row.tmpName }}
        </template>
      </el-table-column>
      ...
      <el-table-column prop="grade" label="年级" width="120" align="center" sortable>
        <template slot-scope="scope">
          {{ scope.row.grade == 1 ? "2018届" : scope.row.grade == 2 ? "2019届" : "2020届" }}
        </template>
      </el-table-column>
      <el-table-column prop="class" label="班级" width="160" align="center" sortable>
        <template slot-scope="scope">
          {{ scope.row.class == 1 ? "计算机2018-1" : scope.row.class == 2 ? "计算机2018-2" : "电气工程2018-1" }}
        </template>
      </el-table-column>
      <el-table-column prop="stuStat" label="状态" width="120" align="center" sortable>
        <template slot-scope="scope">
          <el-tag :type="scope.row.stuStat | statusFilter">{{ scope.row.stuStat ? "在读" : "已毕业" }}</el-tag>
        </template>
      </el-table-column>
